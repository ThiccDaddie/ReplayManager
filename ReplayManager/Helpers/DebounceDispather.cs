...
namespace ReplayManager.Helpers
{
	...
	public class DebounceDispatcher
	{
		...
		/// <param name="action">Action<object> to fire when debounced event fires</object></param>
		/// <param name="param">optional parameter</param> 
		public async Task Debounce<T>(int interval, Action<T> action,
			T param = default)
		{
			// kill pending timer and pending ticks
			if (timer is not null)
		...
		/// <param name="action">Action<object> to fire when debounced event fires</object></param>
		/// <param name="param">optional parameter</param> 
		public async Task Debounce<T>(int interval, Func<T, Task> action,
			T param = default)
		{
			// kill pending timer and pending ticks
			if (timer is not null)
		...
		/// <param name="action">Action<object> to fire when debounced event fires</object></param>
		/// <param name="param">optional parameter</param>
		public async Task Throttle<T>(int interval, Action<T> action,
			T param = default)
		{
			// kill pending timer and pending ticks
			if (timer is not null)
		...
		/// <param name="action">Action<object> to fire when debounced event fires</object></param>
		/// <param name="param">optional parameter</param>
		public async Task Throttle<T>(int interval, Func<T, Task> action,
			T param = default)
		{
			// kill pending timer and pending ticks
			if (timer is not null)
